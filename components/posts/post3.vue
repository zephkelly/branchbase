<template>
  <article ref="postElement" class="post">
    <header>
      <div class="post-info">
      ...
      <h3 class="title">How to create a welcome message for your community</h3>
    </header>
    <section class="body">
      <div class="text-body">
        <div class="content">
...
Before you begin: Welcome messages can only be set from new Reddit on desktop or on the official mobile app. If you use old Reddit, just replace the "www" in your URL with "new" temporarily, set the message, and then go back. If you don't have the app, either go find a desktop or open new Reddit in desktop mode.          </p>
          <p>
Mod permissions required: Since welcome messages are set in the community settings, you would require config perms to manage it          </p>
          <p>
