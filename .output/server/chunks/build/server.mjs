import { hasInjectionContext, inject, version, unref, toRef, isRef, readonly, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, Transition, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentInstance, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, isShallow, isReactive, toRaw, withCtx, defineAsyncComponent } from 'vue';
import { u as useRuntimeConfig$1, $ as $fetch$1, y as withQuery, a as hasProtocol, b as parseURL, z as isScriptProtocol, j as joinURL, l as createError$1, i as defu, A as sanitizeStatusCode, B as createHooks, C as appendHeader, D as getRequestHeaders, s as sendRedirect, F as getHeader, G as toRouteMatcher, H as createRouter$1 } from '../routes/api/user/get-id.get.mjs';
...
const _routes = [
  {
    name: (__nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.name) ?? "b-slug",
    path: (__nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.path) ?? "/b/:slug()",
    meta: __nuxt_page_meta$5 || {},
    alias: (__nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.alias) || [],
    redirect: __nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.redirect,
    component: () => import('./_slug_-DescCy7X.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.name) ?? "edit-b-slug",
    path: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.path) ?? "/edit/b/:slug()",
    meta: __nuxt_page_meta$4 || {},
    alias: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.alias) || [],
    redirect: __nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.redirect,
    component: () => import('./_slug_-BRzepbww.mjs').then((m) => m.default || m)
  },
  {
    name: "explore",
    path: "/explore",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./explore-B-y-pfNE.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-stdhPAO4.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./login-Rml__pxA.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./register-D8_aAxVV.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  "center-align": () => import('./center-align-BvgRr9uN.mjs').then((m) => m.default || m),
  default: () => import('./default-DFWyoC6y.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ERp7OPpj.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-D-WO4fhS.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRuntimeConfig as a, navigateTo as b, useAuth as c, useRoute as d, entry$1 as default, useState as e, asyncDataDefaults as f, useNuxtApp as g, createError as h, injectHead as i, fetchDefaults as j, useRequestFetch as k, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter as u };
