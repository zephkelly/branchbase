...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/center-align.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const centerAlign = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dcad8da8"]]);

export { centerAlign as default };
//# sourceMappingURL=center-align-BvgRr9uN.mjs.map
